...
public class n_queensV2 {
	...
	public static int n;
	// UPDATE ArrayList is much faster than Vector with boards greater than 20x20
	public ArrayList<IntPair> queens;

	n_queensV2() { queens = new ArrayList<IntPair>(); }
	...
	public static void main(String[] args) {
		...
		// FIX benchmarking while waiting for user input skews timings based on
		// how long the user waits to enter input.
		// Placing here instead
		long before = System.currentTimeMillis();

		n_queensV2 q = new n_queensV2();
		q.solveNQueen(0);
